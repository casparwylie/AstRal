...
@property (nonatomic, strong) ViewController * _Null_unspecified viewController;
...
SWIFT_CLASS("_TtC6Astral8Location")
...
- (void)initLocation SWIFT_METHOD_FAMILY(none);
...
@property (nonatomic, strong) UITapGestureRecognizer * _Null_unspecified tapRec;
@property (nonatomic, strong) CLLocation * _Null_unspecified currTempLocation;
...
SWIFT_PROTOCOL("_TtP6Astral23NetworkResponseDelegate_")
...
- (void)addedFocalResponse:(NSString * _Nonnull)responseStr;
- (void)userFocalsResponse:(NSString * _Nonnull)responseStr;
- (void)deletedFocalResponse:(NSString * _Nonnull)responseStr;
- (void)focalCommentsResponse:(NSString * _Nonnull)responseStr;
- (void)postedCommentResponse:(NSString * _Nonnull)responseStr;
- (void)updatedUserDataResponse:(NSString * _Nonnull)responseStr;
- (void)votedCommentResponse:(NSString * _Nonnull)responseStr;
- (void)keyDataResponse:(NSString * _Nonnull)responseStr;
- (void)userKnowsFocalsResponse:(NSString * _Nonnull)responseStr;
- (void)editCommentResponse:(NSString * _Nonnull)responseStr;
- (void)deletedCommentResponse:(NSString * _Nonnull)responseStr;
- (void)saveBackgroundCoordsResponse:(NSString * _Nonnull)responseStr;
@end


SWIFT_PROTOCOL("_TtP6Astral16UIActionDelegate_")
@protocol UIActionDelegate
@optional
- (void)toggleMap:(BOOL)isAddingFocal;
- (void)openLoginForm;
- (void)addFocalReady:(NSString * _Nonnull)comment;
- (void)renderTempFocalFromUI:(NSInteger)tapX tapY:(NSInteger)tapY;
- (void)cancelNewFocal;
...
- (void)logoutUser;
- (void)requestUserFocals;
- (void)deleteFocalRequest:(NSInteger)realID;
- (void)chooseFocalComments:(NSInteger)tapX tapY:(NSInteger)tapY;
- (void)postNewComment:(NSString * _Nonnull)commentText;
- (void)newVoteComment:(NSInteger)vote cID:(NSInteger)cID;
- (void)editComment:(NSString * _Nonnull)text cID:(NSInteger)cID;
- (void)deleteComment:(NSInteger)cID;
- (void)getFocalComments:(NSInteger)focalID updateVisited:(BOOL)updateVisited;
@end


SWIFT_PROTOCOL("_TtP6Astral17mapActionDelegate_")
@protocol mapActionDelegate
@optional
- (void)renderTempFocalFromMap:(CLLocationCoordinate2D)mapTapCoord;
@end
...
SWIFT_CLASS("_TtC6Astral14ViewController")
...
@property (nonatomic, strong) NSTimer * _Null_unspecified reconnectTimer;
@property (nonatomic) MKMapPoint tempFocalMapPoint;
@property (nonatomic, copy) NSArray<CLLocation *> * _Nonnull coordPoints;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull realFocalIDs;
@property (nonatomic) BOOL gotKeyData;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull focalsNotifiedAlready;
@property (nonatomic, readonly, copy) NSString * _Nonnull uuid;
@property (nonatomic, copy) NSString * _Null_unspecified uniqueUsername;
@property (nonatomic) BOOL isStationary;
@property (nonatomic) NSInteger renderCount;
@property (nonatomic) NSInteger regionReqCount;
@property (nonatomic, readonly, copy) NSString * _Nullable firstAppLaunch;
@property (nonatomic, readonly, copy) NSArray * _Nullable userSavedLoggedinData;
@property (nonatomic, readonly, copy) NSArray * _Nullable backgroundCoords;
@property (nonatomic, readonly, copy) NSArray * _Nullable ignoredBackgroundCoords;
@property (nonatomic, copy) NSArray * _Nullable lastBackCoordPos;
- (void)toggleMap:(BOOL)isAddingFocal;
- (void)renderRelFocals:(BOOL)newRender;
...
@property (nonatomic, strong) CLLocation * _Null_unspecified latestDesiredFocalLocation;
- (void)renderTempFocalFromMap:(CLLocationCoordinate2D)mapTapCoord;
- (void)renderTempFocalFromUI:(NSInteger)tapX tapY:(NSInteger)tapY;
- (void)chooseLatestTempPosWithVec:(SCNVector3)vec coordLocation:(CLLocation * _Nonnull)coordLocation mapPoint:(MKMapPoint)mapPoint;
- (void)addFocalReady:(NSString * _Nonnull)comment;
- (void)addedFocalResponse:(NSString * _Nonnull)responseStr;
- (void)cancelNewFocal;
- (void)requestUserFocals;
...
- (void)userLoggedinResponse:(NSString * _Nonnull)responseStr;
- (void)logoutUser;
- (void)initlizeUser SWIFT_METHOD_FAMILY(none);
- (void)getFocalComments:(NSInteger)focalID updateVisited:(BOOL)updateVisited;
- (void)chooseFocalComments:(NSInteger)tapX tapY:(NSInteger)tapY;
- (void)focalCommentsResponse:(NSString * _Nonnull)responseStr;
- (void)postNewComment:(NSString * _Nonnull)commentText;
...
- (void)keyDataResponse:(NSString * _Nonnull)responseStr;
- (void)connWebRetry;
@property (nonatomic, strong) NSTimer * _Null_unspecified checkLocatedTimer;
@property (nonatomic) NSInteger locateDeviceAttempts;
- (void)locatingDeviceMessage;
- (void)checkFirstLaunch;
- (void)startMotionHandler;
- (void)initizeNetwork SWIFT_METHOD_FAMILY(none);
- (void)viewDidLoad;
